...
Use this pack with MaxTAC Core when the target includes source code, generated code, decompiled code, code-scanning findings, exact-path thin closures, negative-evidence source inputs, or source diffs that need auditable closure.
