...
Static analysis is a general skill that is used beyond preparation, but it is relevant here. Read the `maxtac-core-static-analysis` skill for static threat modeling and recon guidance.
