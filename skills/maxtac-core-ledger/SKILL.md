...
MaxTAC MCP convention: use `ledger_init`, `ledger_summary`, `ledger_list`, `ledger_search`, `ledger_add`, `ledger_update`, and `ledger_milestone` before `scripts/ledger.py` when available; keep promotions backed by ledger records.
