...
MaxTAC MCP convention: use `packet_validate` before routing packets into auditors or ledger updates, and use `audit_prompt_create` with `packet_paths` for persisted auditor prompts when available.
